...
wget https://msmarco.z22.web.core.windows.net/msmarcoranking/qidpidtriples.train.full.2.tsv.gz
...
PRETRAIN_DATA_OUTPUT_DIR=$SCRIPT_DIR/../../resources/pretrain_data
echo "Copying pretrain data to $PRETRAIN_DATA_OUTPUT_DIR"
mkdir -p $PRETRAIN_DATA_OUTPUT_DIR
cp $TOKENIZER_ID/query/dev.query.json $PRETRAIN_DATA_OUTPUT_DIR/dev.query.json
cp $TOKENIZER_ID/query/train.query.json $PRETRAIN_DATA_OUTPUT_DIR/train.query.json
cp $TOKENIZER_ID/query/train.query.json $PRETRAIN_DATA_OUTPUT_DIR/train_queries_tokens.jsonl
